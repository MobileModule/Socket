...
import com.xuhao.didi.socket.common.interfaces.default_protocol.DruidDefaultReaderProtocol;
...
public class OkSocketOptions implements IIOCoreOptions {
    ...
    public static OkSocketOptions getDefault() {
        ...
        okOptions.mReaderProtocol = new DruidDefaultReaderProtocol();
        okOptions.mMaxReadDataMB = 5;
        okOptions.mConnectTimeoutSecond = 3;
        okOptions.mWritePackageBytes = 2000;
        okOptions.mReadPackageBytes = 2000;
